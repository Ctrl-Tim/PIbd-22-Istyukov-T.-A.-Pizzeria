...
namespace PizzeriaStorageApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Adding()
        {
            ...
            ViewBag.Warehouses = APIClient.GetRequest<List<StorageViewModel>>("api/Storage/GetStorageList");
            ViewBag.Components = APIClient.GetRequest<List<IngredientViewModel>>("api/Storage/GetIngredientsList");
            return View();
        }
        [HttpPost]
        public void Adding(int storage, int ingredient, int count)
        {
            APIClient.PostRequest("api/Storage/AddIngredientStorage", new ReplenishStorageBindingModel
            {
                StorageId = storage,
