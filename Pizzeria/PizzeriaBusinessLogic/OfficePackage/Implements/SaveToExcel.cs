...
namespace PizzeriaBusinessLogic.OfficePackage.Implements
{
    public class SaveToExcel : AbstractSaveToExcel
    {
        ...
        private static void CreateStyles(WorkbookPart workbookpart)
        {
            ...
            var stylesheetExtension1 = new StylesheetExtension() { Uri = "{EB79DEF2-80B843e5-95BD-54CBDDF9020C}" };
            stylesheetExtension1.AddNamespaceDeclaration("x14", "http://schemas.microsoft.com/office/spreadsheetml/2009/9/main");
            stylesheetExtension1.Append(new SlicerStyles() { DefaultSlicerStyle = "SlicerStyleLight1" });

            var stylesheetExtension2 = new StylesheetExtension() { Uri = "{9260A510-F30146a8-8635-F512D64BE5F5}" };
